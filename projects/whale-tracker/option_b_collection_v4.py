#!/usr/bin/env python3
"""
Option B Collection v4: RESOLUTION FIX
- Dynamic market ID calculation (not hardcoded)
- Sliding window tracking (current ± 6 markets)
- Order books from ACTIVE markets only
- FIXED: Resolution detection (don't wait for transition, record when closed + not yet recorded)
"""
...
PRICE_LOG = DATA_DIR / "prices_v4.jsonl"
ORDERBOOK_LOG = DATA_DIR / "orderbooks_v4.jsonl"
RESOLUTION_LOG = DATA_DIR / "resolutions_v4.csv"
LOG_FILE = DATA_DIR / "option_b_v4_log.txt"
...
log("=" * 100)
log("🚀 OPTION B COLLECTION V4 STARTED (RESOLUTION FIX)")
log("=" * 100)
            ...
            for slug, market_data in list(tracked_markets.items()):
                ...
                try:
                    ...
                    if markets:
                        ...
                        # FIX: Don't wait for transition. Record when closed + not yet recorded
