#!/usr/bin/env python3
"""
Option B Collection v5: TIMER FIX
- Resolution detection now has its own timer (not shared with market discovery)
- Markets ARE closing, resolutions just weren't being detected due to timer collision
"""
...
PRICE_LOG = DATA_DIR / "prices_v5.jsonl"
ORDERBOOK_LOG = DATA_DIR / "orderbooks_v5.jsonl"
RESOLUTION_LOG = DATA_DIR / "resolutions_v5.csv"
LOG_FILE = DATA_DIR / "option_b_v5_log.txt"
...
log("=" * 100)
log("🚀 OPTION B COLLECTION V5 STARTED (TIMER FIX)")
log("=" * 100)
...
last_resolution_check = 0  # SEPARATE TIMER FOR RESOLUTION
tracked_markets = {}
...
try:
    while True:
        ...
        # === CHECK FOR RESOLUTIONS (every 10 seconds) - OWN TIMER ===
